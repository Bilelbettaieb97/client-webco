...
const defaultTestimonials: Testimonial[] = [
  {
    ...
    content: "Notre taux de conversion est passé de 1.8% à 7.2% en 3 semaines. L'investissement s'est remboursé en 10 jours. Webco maîtrise la conversion B2B.",
    rating: 5, sort_order: 1,
  },
  {
    id: "d2", name: "Marc Dubois", role: "CMO", company: "PaySecure",
    content: "On a testé 3 agences avant Webco. La différence ? Ils comprennent le B2B. Chaque élément de la page a un objectif mesurable.",
    rating: 5, sort_order: 2,
  },
  {
    id: "d3", name: "Claire Martin", role: "CEO", company: "TalentHub",
    content: "Le copywriting a tout changé. Nos visiteurs comprennent enfin notre proposition de valeur en 5 secondes. Les demandes de démo ont explosé.",
    rating: 5, sort_order: 3,
  },
  {
    id: "d4", name: "Thomas Petit", role: "VP Marketing", company: "CloudOps",
    content: "Le process est carré : audit, stratégie, exécution, optimisation. Pas de blabla. En 2 semaines on avait une landing page qui convertit x3.",
    rating: 5, sort_order: 4,
  },
  {
    id: "d5", name: "Julie Moreau", role: "Head of Demand Gen", company: "LegalTech Pro",
    content: "L'A/B testing continu nous a permis d'optimiser chaque semaine. Après 2 mois, notre coût par lead a baissé de 60%.",
    rating: 5, sort_order: 5,
  },
  {
    id: "d6", name: "Antoine Bernard", role: "Fondateur", company: "GreenSupply",
    content: "Webco a compris notre marché en un call. La landing page parle directement aux directeurs logistique. Les leads sont ultra-qualifiés.",
...
export function Testimonials({ data }: TestimonialsProps) {
  ...
  return (
    <section id="temoignages" className="relative py-20 sm:py-28 bg-bg overflow-hidden" aria-label="Témoignages">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          badge="Témoignages"
          title="Ce que nos clients B2B en disent"
          subtitle="Des résultats concrets, racontés par ceux qui les vivent au quotidien."
        />
